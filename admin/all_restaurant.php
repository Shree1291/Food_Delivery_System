                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li class="nav-label">Log</li>
								<li><a href="all_restaurant.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>All Restaurant</span></a></li>
								<li><a href="all_menu.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>All Menues</span></a></li>      
